...
public class Dragon{
     ...
     * @return Returns the hashcode of an object of type Dragon.
     */

    @Override
    public int hashCode() {
        return (int) this.id + this.name.hashCode() + this.coordinates.hashCode() + this.creationDate.hashCode() + (int) this.age
                + this.color.hashCode() + this.type.hashCode() + this.character.hashCode() + this.cave.hashCode();
    }

    /**
     * Overridden equals method for the Coordinates class.
     * @param obj - The object to be compared to.
     * @return Returns the result of comparing two objects of type Dragon.
     */

    @Override
    public boolean equals(Object obj) {
        if(this == obj) return true;
        if(obj instanceof Dragon dragonObj){
            return (this.id == dragonObj.getId()) && (Objects.equals(this.name, dragonObj.getName())) && (this.coordinates.equals(dragonObj.getCoordinates()))
                    && (Objects.equals(this.creationDate, dragonObj.getCreationDate())) && (this.age == dragonObj.getAge())
                    && (Objects.equals(this.color, dragonObj.getColor())) && (Objects.equals(this.type, dragonObj.getType()))
                    && (Objects.equals(this.character, dragonObj.getCharacter())) && this.cave.equals(dragonObj.getCave());
        }
        return false;
    }
}